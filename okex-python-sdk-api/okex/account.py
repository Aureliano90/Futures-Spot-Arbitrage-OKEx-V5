...
class AccountAPI(Client):
    ...
    async def async_get_specific_position(self, instId: str) -> List[dict]:
        """查看持仓信息\n
    ...
    def get_account_balance(self) -> dict:
        ...
        """
        return self._request_without_params(GET, ACCOUNT_BALANCE)['data'][0]

    async def async_get_coin_account(self, currency) -> dict:
        """获取账户中单币种余额\n
    ...
    async def async_get_ledger(self, instType, ccy, mgnMode='', ctType='', type='', subType='', after='', before='', limit=''):
        """账单流水查询\n
