...
class TradeAPI(Client):
    ...
    async def async_take_spot_order(self, instId, side, order_type, size, price='', client_oid='') -> dict:
    ...
    async def async_take_swap_order(self, instId, side, order_type, size, price='', client_oid='', reduceOnly=False) -> dict:
    ...
    async def async_get_order_info(self, instId, order_id='', client_oid='') -> dict:
        """获取订单信息\n
